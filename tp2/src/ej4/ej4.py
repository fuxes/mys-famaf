...
def graficar_normal(v):
	...
	pylab.ylim(0, 0.15)
	pylab.legend()
	pylab.title(u'Ajuste Normal de las ganancias semanales')
	pylab.xlabel(u'Ganancias semanales ($)')
	pylab.ylabel(u'Frecuencia')
	pylab.grid()
	pylab.show()
...
def graficar_lognormal(v):
	...
	pylab.ylim(0, 0.15)
	pylab.legend()
	pylab.title(u'Ajuste Lognormal de las ganancias semanales')
	pylab.xlabel(u'Ganancias semanales ($)')
	pylab.ylabel(u'Frecuencia')
	pylab.grid()
	pylab.show()
...
def graficar_gamma(v):
	...
	pylab.ylim(0, 0.15)
	pylab.legend()
	pylab.title(u'Ajuste Gamma de las ganancias semanales')
	pylab.xlabel(u'Ganancias semanales ($)')
	pylab.ylabel(u'Frecuencia')
	pylab.grid()
	pylab.show()
